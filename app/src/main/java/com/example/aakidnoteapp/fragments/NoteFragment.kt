...
import com.example.aakidnoteapp.adapters.RvNotesAdapter
import com.example.aakidnoteapp.databinding.FragmentNoteBinding
import com.example.aakidnoteapp.utils.SwipeToDelete
...
//            navController.navigate(NoteFragmentDirections.actionNoteFragmentToSaveOrDeleteFragment())
        ...
        noteBinding.rvNote.setOnScrollChangeListener{_,scrollX,scroolY,_,oldScrollY->
    ...
    private fun swipeToDelete(rvNote: RecyclerView) {
        val swipeToDeleteCallback=object : SwipeToDelete()
        {
            override fun onSwiped(viewHolder: RecyclerView.ViewHolder, direction: Int) {
                ...
                val  note=rvAdapter.currentList[positon]
    ...
    private fun observetDataChanges() {
