package com.example.aakidnoteapp.adapters
...
import com.example.aakidnoteapp.databinding.NoteItemLayoutBinding
import com.example.aakidnoteapp.fragments.NoteFragmentDirections
...
class RvNotesAdapter:
    ListAdapter<Note, RvNotesAdapter.NotesViewHolder>(DiffUtilCallback()){
    ...
    override fun onBindViewHolder(holder: NotesViewHolder, position: Int) {
        getItem(position).let { note ->
            holder.apply {
                ...
                date.text=note.date
//                parent.setCardForegroundColor(note.color)
